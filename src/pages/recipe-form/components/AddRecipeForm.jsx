      ...
      <CreateRecDiv>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="category-div">
            <StyledSelect id="course" name="course" onChange={ingredientChange}>
            ...
            <StyledSelect id="cuisine" name="cuisine" onChange={ingredientChange}>
            ...
            <StyledSelect id="dietaryconcerns" name="dietaryconcerns" onChange={ingredientChange}>
            ...
            <StyledSelect id="technique" name="technique" onChange={ingredientChange}>
